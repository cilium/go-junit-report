...
var (
	...
	// codeowners
	logOwners        = flag.String("code-owners", "", "read GitHub CODEOWNERS definitions and hydrate test cases with ownership")
	logOwnersPrefix  = flag.String("code-owners-prefix", "", "repository prefix to strip from package names in order to match paths in CODEOWNERS")
	logOwnersExclude = flag.String("code-owners-exclude", "", "list of code owners to exclude from output")
...
func main() {
	...
	if *logOwnersPrefix != "" {
		...
		if logOwnersExclude != nil {
			exclude := strings.Split(*logOwnersExclude, ",")
			o = o.WithExcludedOwners(exclude)
		}
		owners = o
	}
